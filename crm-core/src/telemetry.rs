...
///
/// Apply an `EnvFilter` using the `RUST_LOG` environment variable to define
/// the log levels, add a formatter layer logging as JSON and an OpenTelemetry layer
/// exporting tracing data if tracing is enabled.
