...
#[derive(derive_builder::Builder, Clone, Copy, PartialEq, ::prost::Message)]
...
pub mod user_stats_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<tonic::codec::Streaming<super::User>>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static("/user_stat.UserStats/Query");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user_stat.UserStats", "Query"));
        ...
        ) -> std::result::Result<tonic::Response<tonic::codec::Streaming<super::User>>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/user_stat.UserStats/RawQuery");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("user_stat.UserStats", "RawQuery"));
            self.inner.server_streaming(req, path, codec).await
        }
    }
}
...
pub mod user_stats_server {
    ...
    pub const SERVICE_NAME: &str = "user_stat.UserStats";
